...
/**
 * �bergeordnete, abstrakte Klasse von denen alle im Spiel vorkommenden Objekte erben
...
public abstract class GameObject {
	 ...
	 * @param passable Legt fest, ob das Element durchl�ssig ist
	...
	/**
	 * Abstrakte Render Methode, die mit einem SpriteBatch bef�llt werden muss
	 * @param sb Legt das SpriteBatch fest
	 */
	public abstract void render(SpriteBatch sb);
	
	/**
	 * Abstrakte Update Methode, die mit der deltaTime bef�llt wird
