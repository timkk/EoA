 ...
 * Mit dem Objekt wird eine Textur einer png-Datei �bergeben was auf dem Spielfeld gerendert wird.
...
public class Death extends GameObject{
	...
	/**
	 * Textur f�r ein Zeichen der Position
	 * 
	 * @author pbg2h15are
	 */
	 ...
	 * 
	 * Mit �bergabewert der letzten Position des Spielers bevor er von einer Bombenexplosion getroffen wird.
	 ...
	 * In Bearbeitung!
	 * 
	 * Render-Methode f�r die <code>LocalGameState</code>
	 * 
	 * @author pbg2h15are
	 */
	@Override
	 ...
	 * In Bearbeitung!
	 * 
	 * Update-Methode f�r die <code>LocalGameState</code>
	 * 
	 * @author pbg2h15are
	 */
	@Override
