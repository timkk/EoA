...
/**
 * Erstellt das Hauptmen� mit den drei Auswahlbuttons und deren Funktion
 * 
 * @author pbg2h15aza
 * @author pbg2h15awi
 * 
...
public class MainMenuState extends GameState {
	 ...
	 * 
	 * Erstellt die Main Menu Buttons und versieht diese mit den zugh�rigen Texturen
	 * Zus�tzlich wird die Main Menu Musik abgespielt und ein SpriteBatch erstellt
	 * 
	 */
	@Override
	public void init() {
	...
	/**
	 * Wechselt in das zugeh�rige Men�, wenn auf den Start/-Quit/-Options Button geklickt wird
	 * 
	 * Wechselt in die Modiauswahl, wenn auf den Startbutton geklickt wird
	 * Wechselt in das Optionsmen�, wenn auf den Optionsbutton geklickt wird
