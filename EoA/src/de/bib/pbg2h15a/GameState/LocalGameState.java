...
public class LocalGameState extends GameState {
	 ...
	 * PowerUps bzw. Debuffs und Krankheiten k�nnen durch eine Kollision vom Spieler eingesammelt werden.
	 * Und die KI Logik der KI-Klasse wird aufgerufen um den computergesteuerten Gegenspieler zum Leben zu erwecken.
	 * Au�erdem werden Bomben, die sich auf den Spielfeld befinden, nach einer bestimmtent Zeit(Timer) entfernt und erzeugen anschlie�end an ihrer Stelle eine Explosionsanimation(mit Explosionsradius).
	 ...
	 * Sobald die Spielzeit kleiner 11 betr�gt, wird ein Countdown gestartet und eingeblendet.
	 * 
	...
	public void update(float dt) {
		...
		if (timer.isFinished() && !pausiert) {
			...
			for (Bomb b : bombs) {
				...
				// erm�glicht von Bombe runter gehen nach platzieren
			...
			for (Wall w : walls) {
				...
				// Kollision mit Explosion -> entfernen und m�gliches
	...
	/**
	 * Sobald ein Punkt (insbesondere der einer Bombe) �ber den Spielfeldrand gelangt wird es auf die gegen�berliegende Seite gesetzt.
	 ...
	 * @return Warnung bei 10 Sekunden verbleibend eingef�gt
	 */
	@Override
	public void render() {
...
//		}		
	...
	/**
	 * Generiert die W�nde, die die Spielbegrenzung und die sich im Spielfeld befindenden S�ulen darstellen.
	 * 
	 * @author pbg2h15awi
	 * @param width
	 *            breite des felds
	...
	/**
	 * �berpr�ft eine Liste GameObjekten, ob sie mit einem Punkt kolliedieren
	 * 
	 * @author pbg2h15asu
	 * @param p
	 *            Position des Objects
	 * @param objects
	 *            Objekte die auf Kollision �berpr�ft werden sollen
	...
	/**
	 * 
	 * �berpr�ft eine Liste PowerUps/Debuffs bzw Illness, ob sie mit einem Punkt kolliedieren
	 * 
	 * @param p der Punkt!!!
	...
	/**
	 * �berpr�ft die Kollison zwischen zwei GameObjekten
	...
	/**
	 * �berpr�ft, ob das Spiel vorbei ist
	 * 
	 * 
	 * @author pbg2h15ani
	 */
	...
	/***
	 * 
	 * �ndert den Spielzeitzusatnd in den entgegengesetzten Zustand
	 * 
	 * @author pbg2h15afo
	 */
