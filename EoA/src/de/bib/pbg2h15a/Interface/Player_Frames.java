...
/**
 * Stellt die Bild-Dateien der Sprites als <code>Enum</code> zu Verf�gung.
...
public enum Player_Frames {
	...
	/**
	 * Gibt ein Bild f�r verschiedene Bewegungsabl�ufe zur�ck.
	 * (Kommentiert von pbg2h15akl)
	 * @param vers Wert, f�r den die Bewegunganimation ausgew�hlt wird.
	 * @return
	 */
