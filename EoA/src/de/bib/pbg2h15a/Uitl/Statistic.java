...
public class Statistic {
	...
	/**
	 * H�ngt Statistiken an vorhandene an, z.B.: Ergebnisse von Runde 1 und Runde 2 werden zusammengefasst.
	 * @author pbg2h15asu
	 * @param s Statistik, die hinzugef�gt wird, Werte werden �bernommen
	 */
